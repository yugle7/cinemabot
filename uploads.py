...
tasks = [
    loop.create_task(upload_media_files('pics', bot.send_photo, 'photo')),
    loop.create_task(upload_media_files('videos', bot.send_video, 'video')),
    loop.create_task(upload_media_files('videoNotes', bot.send_video_note, 'video_note')),
    loop.create_task(upload_media_files('files', bot.send_document, 'document')),
    loop.create_task(upload_media_files('ogg', bot.send_voice, 'voice')),
]
